...
from utils.datasets import IMG_FORMATS, VID_FORMATS, LoadImages, LoadROSStreams
...
def run(
    ...
    if webcam:
        ...
        dataset = LoadROSStreams(source, img_size=imgsz, stride=stride)
